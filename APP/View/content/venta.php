...
<form action="" method="get">
    <!-- <label for="">ID</label>
    <input type="number" name="Id" id="" placeholder=" "><br> -->

    <label for="">Comprobante</label>
    <input type="text" name="Comprobante" id="" placeholder=" "><br>

    <label for="">Tipo Comprobante</label>
    <input type="text" name="Tipo_Comprobante" id="" placeholder=" "><br>

    <label for="">Numero</label>
    <input type="text" name="Numero" id="" placeholder=" "><br>

    <label for="">Fecha</label>
    <input type="date" name="Fecha" id="" placeholder=" "><br>

    <label for="">CUIL Contribuyente</label>
    <input type="number" name="Id_Contribuyente" id="" placeholder=" "><br>
    <!-- mostrar cuil Contribuyente -->

    <label for="">Neto 21%</label>
    <input type="number" name="Neto_" id="" placeholder=" "><br>
    ...
    <input type="number" name="Iva_" id="" placeholder=" "><br>
    ...
    <input type="number"" name="Peiodo" id="" placeholder=" "><br>

    <!-- <label for="">Signo</label>
    <input type="number" name="Signo" id="" placeholder=" "><br> -->
